...
export default function TikTokBrowserNotice() {
  return (
    <div className="min-h-screen bg-[#0B0E11] px-4 py-10 flex items-center justify-center">
      <div className="w-full max-w-md rounded-[28px] shadow-[0_20px_60px_rgba(15,23,42,0.12)]">
        <div className="mb-5 flex justify-center w-full h-full bg-red-400 text-7xl"> 🤭 </div>

<div className="text-neutral-400 rotate-270 w-15">
