...
export default function SectionCardsMentoria() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto py-10 px-2 items-start ">
      ...
      {/* CARD 2 */}
      <div className="bg-white rounded-2xl shadow-xl p-6 flex flex-col border border-neutral-300 hover:scale-105 transition duration-300 min-h-[650px]">
        <h3 className="text-xl font-semibold text-gray-800 mb-2">MENTORIA VIP (PRESENCIAL)</h3>
        <p className="text-gray-600 mb-4">La experiencia más completa, personalizada e intensiva</p>
      ...
      <div className="bg-white rounded-2xl shadow-xl p-6 flex flex-col border border-neutral-300 hover:scale-105 transition duration-300 min-h-[650px]">
        ...
        <p className="text-gray-600 mb-4">
          CryptoTour 2026 Inconfiscable es la gira educativa que está impulsando una nueva forma de entender y proteger el patrimonio en la era digital.
        </p>
        <a href="https://fusionplusdigital.com/eventos/" className="mt-auto bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-green-700 transition text-center">
